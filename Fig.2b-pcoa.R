...
sample_site$high <- factor(sample_site$high, levels = c('5k', '7k', '8k', '9k', '10k'))
...
pcoa_plot <- ggplot(sample_site, aes(PCoA1, PCoA2, group = Site)) +
  ...
  annotate('text', label = 'Slope', x = -0.31, y = -0.15, size = 5, colour = '#C673FF') +
  annotate('text', label = 'Bottom-axis', x = 0.32, y = 0.05, size = 5, colour = '#FF985C')
pcoa_plot
