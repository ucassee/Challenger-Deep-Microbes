...
group <- read.delim('E:/我的坚果云/Project/Mariana586/3.Annotation/0.Kegg/genegroup.txt', sep = '\t', stringsAsFactors = FALSE)
data
data2 <- data %>%
  group_by(kegg) %>%
  summarise(sd = sd(Abundance),tpm = mean(Abundance),min=min(Abundance),max=max(Abundance))
data2
data2$kegg = factor(data2$kegg, levels=c('K00845','K01610','K01647','K00031','K00174','K00625','K00925','K01895','K00169','K15230','K15231','K00198','K14138','K01938','K18594','K18593','K14534','K01601','K00855','K03320','K00605','K00261','K10944','K10535','nxrA','narG','K00367','K02567','K00362','K03385','K00366','K00368','K04561','K00376','K00958','K00394','K11180','K08352','K17218','K00390','K00392','K01738','K03381','K07104','K00449','K04101','K15512','K00496','K20938','K03892','K01551','K00537','K03741','K08356','K01042','K01008','K06917'))
data2
